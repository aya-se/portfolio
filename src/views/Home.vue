<template>
  <div id="home">
    ...
    <div id="top">
      ...
      <div class="top-text">
        東京工業大学<br />情報理工学院 情報工学系 修士課程2年<br />岡崎研究室
      </div>
      ...
      <div class="top-description-container">
        <p class="top-description">
          ...
          <br />
          現在は，大規模言語モデル（LLM）『Swallow』の構築プロジェクトに参加し，事前学習コーパスについての研究を行っています．特に，どのようなテキスト・データがLLMのどのようなタスクの性能に影響を与えているのか，といった細かな解析やコーパスの品質改善に取り組みたいと考えています．
          <br />
